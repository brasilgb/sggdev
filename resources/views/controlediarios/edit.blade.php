                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb pt-1 pb-1 float-right bg-transparent">
                            ...
                            <li class="breadcrumb-item"> <a href="{{ route('controlediarios.index') }}">Controle diário</a></li>
        ...
        <form id="formlote" action="{{ route('controlediarios.update', ['controlediario' => $controlediario->id_controle]) }}" method="post" autocomplete="off">
            <div class="card-body px-4">
                ...
                <input type="hidden" id="idcontrole" value="{{$controlediario->id_controle}}">
                    ...
                    <div class="form-group row">
                        <label for="leitura_edit" class="col-sm-3 col-form-label text-left">Leitura da água <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-7">
                            <input id="leitura_edit" type="text" class="form-control" name="leitura_agua"
