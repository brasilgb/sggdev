...
<div class="relatorio">
    ...
    <table>
        ...
        <tr>
            ...
            @endforeach
            <td class="bg-gray">
                {{ $coletas->where('lote_id', $lote->id_lote)->where('data_coleta', $datarelatorio)->sum('refugos') }}
            </td>
        </tr>
        <tr>
            <td>Deformados</td>
        ...
        <tr>
            ...
            @endforeach
            <td class="bg-gray">
                {{ $coletas->where('lote_id', $lote->id_lote)->where('data_coleta', $datarelatorio)->sum('eliminados') }}
            </td>
        </tr>
        <tr class="bg-gray-light">
