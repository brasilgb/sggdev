...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header pb-0 border-bottom border-white">
            <div class="row">
                <div class="col">
                    <h4 class="text-left text-body mt-1"><i class="fas fa-file-alt"></i> Estoque ovos</h4>
                </div>
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb pt-1 pb-1 float-right bg-transparent">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                            <li class="breadcrumb-item active"> Estoque ovos</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="card-body p-4 ">
            ...
            <div class="row mb-4 pb-4 border-bottom" style="border-color: rgb(189, 188, 188)">
                <div class="col-3">
                    ...
                    <form action="{{ route('relatorios.pdfestoqueovo') }}" method="post" class="inline" target="_blank">
                        @method('POST')
                        @csrf
