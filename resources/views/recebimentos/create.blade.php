...
@section('content')
    ...
    <div class="card shadow-sm">
        <div class="card-header pb-0 border-bottom border-white">
            <div class="row">
                <div class="col">
                    <h4 class="text-left text-body mt-1"><i class="fa fa-pallet"></i> Recebimentos</h4>
                </div>
                <div class="col">
        ...
        <form id="formlote" action="{{ route('recebimentos.store') }}" method="post" autocomplete="off">
            <div class="card-body px-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input id="dataform" type="text" class="form-control" name="data_recebimento"
                            value="{{ old('data_recebimento', date('d/m/Y', strtotime(now()))) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input id="hora_recebimento" type="text" class="form-control" name="hora_recebimento"
                            value="{{ old('hora_recebimento', date('H:i', strtotime(now()))) }}">
                ...
                <div class="form-group row">
                    <label for="nota_fiscal" class="col-sm-3 col-form-label text-left">Nota fiscal <span
                            class="text-danger">*</span></label>
                    <div class="col-sm-7">
                        <input id="nota_fiscal" type="text" class="form-control" name="nota_fiscal" value="{{ old('nota_fiscal') }}">
                        @error('nota_fiscal')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
